    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            <Button className="hidden sm:flex px-5 h-10 font-bold text-white bg-[#0B56D5] rounded-full shadow-md shadow-blue-500/25 cursor-pointer">
              Đăng ký
            </Button>
          </motion.div>
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-72 p-0">
              ...
              <div className="p-6 border-t space-y-3">
                <Button variant="outline" className="w-full font-semibold h-11 cursor-pointer">
                  Đăng nhập
                </Button>
                <Button className="w-full font-bold text-white bg-[#0B56D5] h-11 cursor-pointer">
                  Đăng ký ngay
                </Button>
              </div>
            </SheetContent>
