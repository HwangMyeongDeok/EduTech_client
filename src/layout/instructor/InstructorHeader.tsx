...
// Dùng chung components với Student cho đồng bộ hoặc ông tự tạo bản copy sang instructor/components
import { SearchBar } from "../student/components/SearchBar";
import { NotificationDropdown } from "../student/components/NotificationDropdown";
import { UserDropdown } from "../student/components/UserDropdown";

interface HeaderProps {
  onOpenMobileMenu: () => void;
}

export function InstructorHeader({ onOpenMobileMenu }: HeaderProps) {
          ...
          <div className="relative" ref={userRef}>
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                <p className="text-xs font-bold text-slate-800 leading-none mb-0.5">{user?.name || "Giảng viên"}</p>
                <p className="text-[10px] font-medium text-amber-500 uppercase tracking-wider flex items-center gap-1">Top Instructor</p>
              </div>
            </button>
            <AnimatePresence>
